  ...
  return (
    <OnboardingLayout currentStep={2}>
      <div className="text-center mb-6 space-y-2">
        ...
        {/* Team Badge */}
        {teamName && (
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface-darker/80 backdrop-blur-md border border-white/10 rounded-full shadow-lg mt-2">
              ...
              <div className="w-full md:w-1/2 relative h-full flex items-end justify-center z-10 overflow-visible">
                ...
                {currentPlayerMeta?.imageUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center opacity-10">
                    <span className="material-symbols-outlined text-[200px] text-white">person</span>
                  </div>
                )}
              </div>
            </div>
