                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex items-center gap-6 justify-center md:justify-start text-sm text-gray-500 font-mono">
                            ...
                            <span className="flex items-center gap-1"><span className="material-icons-outlined text-base">location_on</span> Los Angeles, CA</span>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button className="bg-surface-dark border border-white/10 hover:border-primary/50 text-white hover:text-primary px-4 py-2.5 rounded-xl transition cursor-pointer">
