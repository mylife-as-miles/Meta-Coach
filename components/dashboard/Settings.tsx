                ...
                <aside className="col-span-12 lg:col-span-3 flex flex-col gap-2">
                    <div className="bg-surface-dark rounded-2xl border border-white/10 p-2 shadow-lg">
                        <nav className="flex flex-col gap-1">
                            <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-white/5 hover:text-white transition group cursor-pointer">
                                <span className="material-symbols-outlined text-xl group-hover:text-primary transition">manage_accounts</span>
                                <span className="font-medium text-sm">Account</span>
                            </a>
                            <a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 border border-primary/20 text-white transition shadow-[0_0_10px_rgba(210,249,111,0.05)] cursor-pointer">
                                <span className="material-symbols-outlined text-primary text-xl">groups</span>
                                <span className="font-medium text-sm text-primary">Team Configuration</span>
                            </a>
                            <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-white/5 hover:text-white transition group cursor-pointer">
                            ...
                            <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-white/5 hover:text-white transition group cursor-pointer">
                                <span className="material-symbols-outlined text-xl group-hover:text-primary transition">notifications</span>
                                <span className="font-medium text-sm">Notifications</span>
                            </a>
                            <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-white/5 hover:text-white transition group cursor-pointer">
                                <span className="material-symbols-outlined text-xl group-hover:text-primary transition">tune</span>
                                <span className="font-medium text-sm">AI Calibration</span>
                            </a>
                        </nav>
                    </div>
